...
library Pairing {
   ...
   function P2() internal pure returns (G2Point memory){
    ...
    ///@return r the product of a point on G1 and a scalar, that is,
...
///points p.
    ...
    function scalar_mul(G1Point memory p, uint s) internal view returns (G1Point memory r){
        ...
        assembly{
            ...
            //using invalid to make gas estimation work
            switch success case 0 {invalid()}
        } 
    ...
    ///for example pairing([P1(), P1().negate()], [P2(), P2()])
    ///return true.
    ...
    ///Convenience method for a paiting check for two pairs
...
contract Verify {
    ...
    function verify(uint[] memory input, Proof memory proof) internal view returns (uint){
        ...
        require(input.length + 1 == vk.IC.length, "bad input for verifier");
        ...
        vk.alpha1, vk.beta2, vk_x, vk.gamma2, proof.C, vk.delta2)) return 1;
        return 0;
    }
